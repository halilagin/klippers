...
def _process_segments(input_video, important_segments_file_json, srt_file, output_dir):
...
def extract_video_segments_command(
    ...
    """
    _process_segments(input_video, important_segments_file_json, srt_file, output_dir)
