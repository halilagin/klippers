...
import TrialShortVariation from '../components/TrialShortVariation';
...
const KlippersTrial = () => {
  ...
  const [actionType, setActionType] = useState<'download' | 'publish' | null>(null);
  ...
  const handleLogin = () => {
    ...
    window.location.href = '/klippers-login';
  };

  const handlePricing = () => {
    // Navigate to pricing page
    window.location.href = '/klippers-pricing';
  };
        ...
        <Container maxWidth="lg">
          <Box sx={{
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              <Chip 
                label="1 Credit" 
                icon={<span style={{ fontSize: 16, color: '#c6f479' }}>⚡</span>}
                sx={{ 
                  bgcolor: 'rgba(198, 244, 121, 0.2)',
                  color: '#c6f479',
                  fontWeight: '600',
                  fontSize: '0.8rem',
                  borderRadius: 12,
                  border: '1px solid rgba(198, 244, 121, 0.3)',
                  '& .MuiChip-label': {
                    px: 1
                  }
                }} 
        ...
        <Box sx={{ mb: 8, width: '100%' }}>
          <Box sx={{ pl: 2 }}>
            ...
            <Typography variant="body1" sx={{ color: '#808080', mb: 4 }}>
              Generated from patrick-part1.mp4 (38:00)
            </Typography>
      ...
      >
        ...
        <DialogContent>
          <Typography sx={{ color: '#808080', mb: 3 }}>
            Please subscribe to {actionType} this short video.
          </Typography>
        </DialogContent>
